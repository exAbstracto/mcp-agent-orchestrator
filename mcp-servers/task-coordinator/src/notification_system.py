...
class NotificationEvent:
    ...
    def __init__(self, event_type: str, task_id: str, newly_ready_tasks: List[str], timestamp: Optional[datetime] = None):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            self.newly_ready_tasks == other.newly_ready_tasks and
...
class NotificationSystem:
    ...
    def register_callback(self, event_type: str, callback: NotificationCallback) -> None:
        """
    ...
    def unregister_callback(self, event_type: str, callback: NotificationCallback) -> None:
        """
