...
def run_comprehensive_test():
    ...
    infrastructure_ok = (
        claude_dir.exists() and
        cursor_dir.exists() and
        (claude_dir / "shared-workspace").exists() and
        (claude_dir / "shared-workspace" / "coordination" / "agent-registry.json").exists()
    )
